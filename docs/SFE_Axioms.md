...
본 문서의 3대 공리(연산-기하 등가성, 최소 연산 작용, 해상도 한계)는 SFE의 철학적/구조적 기초이다. 정량적 예측을 위한 조작적(operational) 공리 체계는 `docs/경로적분.md`에서 다음 4개로 정식화되어 있다.
...
|---|---|---|
| 제1공리 (연산-기하 등가성) | A1 ($\Phi = \delta^2 S/\delta\gamma^2 = R$) | 억압장 = 곡률의 동일성으로 구체화 |
