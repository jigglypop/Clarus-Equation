...
| # | 폴더 | 내용 |
|---|------|------|
| 0 | [0_검증과감사/](0_검증과감사/) | 증명 상태표, 검산 ledger, validation framework, 미해결 난제 목록, 문서 완성도 감사 |
| 1 | [1_강의/](1_강의/) | 연역적/귀납적 유도, 5상수(0,1,e,pi,i) 해설 |
| 2 | [2_경로적분과_응용/](2_경로적분과_응용/) | 차원 유일성, 인플레이션, 강한 CP, 중성미자, 바리온 비대칭, 페르미온 질량, 자기재귀성 대칭 등 14편 |
| 3 | [3_상수/](3_상수/) | 8층 상수 유도 상세와 우주론 수식 의미 지도 (격자기본량, 혼합, 부트스트랩, CKM, PMNS, 질량, 우주론, 차원스케일링, 우주론 수식 의미) |
