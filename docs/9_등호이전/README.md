...
| [05c_pathspace_closure_checklist.md](05c_pathspace_closure_checklist.md) | CE 경로공간 농축 정리 적용 조건 | `[정의]`, `[미완성]` |
| [05d_pathspace_audit.md](05d_pathspace_audit.md) | CE 문서의 $\mathcal P_I$, $\mu_{\mathrm{ref}}$, $W/F$, $\mathcal P_{\mathrm{ns}}$ 감사 | 조건부 `[정리]`, 남은 사상은 `[미완성]` |
...
| [05j_CE_supp_scaling_audit.md](05j_CE_supp_scaling_audit.md) | suppression 사용처와 scale 규약 감사 | `[산출]`, `[공리: 모델 선택]`, `[미완성]` |
...
| [05m_CE_mode_decomposition_audit.md](05m_CE_mode_decomposition_audit.md) | Gamma mean-field 비, equicorrelation 분산과 scaling 경계 | 조건부 `[정리]`; 물리 mode 구조는 `[미완성]` |
| [05n_CE_cosmology_modern_audit.md](05n_CE_cosmology_modern_audit.md) | 지수 고정점 정리와 우주론 forward 사상의 경계 | `[정리]`, `[공리]`, `[산출]`, `[미완성]` |
...
25. [05m_CE_mode_decomposition_audit.md](05m_CE_mode_decomposition_audit.md): intensive/extensive mode scaling과 조건부 오차
26. [05n_CE_cosmology_modern_audit.md](05n_CE_cosmology_modern_audit.md): 고정점 수학과 우주론 사상의 범위 구분
