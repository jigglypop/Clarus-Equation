...
_FREEZE_FILES = (
    Path("reality_stone/python/reality_stone/clarus/runtime_prediction_guided_metacontrol.py"),
    Path("reality_stone/python/reality_stone/clarus/runtime_prediction_guided_metacontrol_benchmark.py"),
