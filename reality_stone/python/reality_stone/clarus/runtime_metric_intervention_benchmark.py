...
_FREEZE_FILES = (
    "reality_stone/python/reality_stone/clarus/runtime_metric_intervention.py",
    "reality_stone/python/reality_stone/clarus/runtime_metric_intervention_benchmark.py",
