...
_FREEZE_FILES = (
    ...
    "reality_stone/python/reality_stone/clarus/runtime_metric_sufficiency.py",
    "reality_stone/python/reality_stone/clarus/runtime_metric_sufficiency_benchmark.py",
