...
2026-09-22 현재 작업: [고정밀 경험식 복원과 교차 역예측](paper/후속연구_기록과_상태선택/38_고정밀_경험식의_복원과_교차_역예측.md).
암흑부문·뮤온·허블의 옛 성공 식을 보존하고, 뮤온→밀도·허블 역함수,
유한핵의 저에너지 구현, DE 퍼텐셜 구성을 추가했다.
[재현 코드와 원본 해시](experiments/ce_empirical_inverse_20260922/README.md)를 함께 제공한다.
같은 미시 작용에서 이 조건을 선택하는 증명과 공동 관측 검증은 남아 있다.
