...
def common_metric_block(
    ...
    *,
    ...
    """Align and sum simple cells in one positive Euclidean metric orbit."""
    ...
    # Validate the theorem's positive, nondegenerate Euclidean branch even for
    # the singleton case, where no pairwise metric residual is evaluated.
