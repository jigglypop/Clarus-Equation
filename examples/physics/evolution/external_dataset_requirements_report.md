...
| `zebrafish_continuous_movement` | 0.000 | 0 | `e2_frame_timestamp`, `e2_resampled_speed_or_position`, `turn_or_heading_trace`, `fish_or_session_id`, `alignment_quality_or_sync_marker` | `zebrafish_timestamp_certified_continuous_gate.py` |
