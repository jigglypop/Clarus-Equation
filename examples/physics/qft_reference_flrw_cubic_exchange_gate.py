'''Reproduce the E68 scalar cubic-exchange resonance admission gate.'''
...
def main() -> None:
    ...
    print(
        json.dumps(
            {
                'all_declared_exchange_gates_passed': all(
                    item['declared_exchange_gate_passed'] for item in receipts
                ),
