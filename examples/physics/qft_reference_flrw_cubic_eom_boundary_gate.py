'''Reproduce the E68 frozen scalar EOM/boundary quotient gate.'''
...
def main() -> None:
    ...
    print(
        json.dumps(
            {
                'all_declared_eom_boundary_gates_passed': all(
                    item['declared_eom_boundary_gate_passed'] for item in receipts
                ),
