...
감사(2026-09-26, 원장 §43.111): 숫자·예산 상한·f < 3 기준·빛원뿔이 허블 부피 하나를 덮는다는 것은 맞다. 정정: 바다는 띠를 한 번
  지날 뿐이라 "차원 0.115 이상의 프랙털로 남는다"와 OBJ-02의 "정확한 꼴"은 과장이다. 3 − f는 그 순간의 불어남 지수다.
  철회: T3 곡률 연결(Q의 안쪽은 기록 시각과 무관하게 평탄하다, §43.108 감사). 10^{−5.7e5}은 길이 비다(부피 비는 10^{−1.7e6}).
