...
감사(2026-09-26, 원장 §43.111): 숫자는 모두 재현되었다. §43.108이 여기에 단 정정("CE에서는 열린 거품이 돌아온다")은 철회되었다.
  CE(Q)에서도 안쪽은 평탄하다. look-elsewhere 기대를 국소 밀도로 세면 0.35–0.49칸(29–39%)이고 결론은 같다.
