...
# --- C. SFE 방패 (Genetic Optimized) ---
# SFE Engine Optimized Sequence (Generated 2025-11-23, Hardware-Matched)
sfe_ratios = [0.0010, 0.0040, 0.0085, 0.0150, 0.0235, 0.0440, 0.0460, 0.0595, 0.0750, 0.0920, 0.1105, 0.1305, 0.1520, 0.1745, 0.1985, 0.2240, 0.2500, 0.2770, 0.3070, 0.3340, 0.3630, 0.3930, 0.4235, 0.4540, 0.4845, 0.5155, 0.5460, 0.5765, 0.6070, 0.6370, 0.6660, 0.6950, 0.7230, 0.7500, 0.7760, 0.7925, 0.8255, 0.8480, 0.8695, 0.8895, 0.9080, 0.9250, 0.9405, 0.9540, 0.9660, 0.9765, 0.9850, 0.9915, 0.9960, 0.9990] 
