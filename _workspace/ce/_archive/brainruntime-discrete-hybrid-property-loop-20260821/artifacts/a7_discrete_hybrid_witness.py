...
def main() -> int:
    ...
    try:
        ...
        package_version_source = "importlib.metadata"
    except importlib.metadata.PackageNotFoundError:
        package_version = getattr(reality_stone, "__version__", "UNAVAILABLE")
        package_version_source = "reality_stone.__version__"
    result = {
        ...
        "provenance": {
            ...
            "reality_stone_version_source": package_version_source,
