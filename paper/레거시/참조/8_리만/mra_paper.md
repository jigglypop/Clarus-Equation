...
`paper` Markdown 코퍼스 (400 K chars, vocab 788) 에서 char-level LM,
...
| 항목 | 값 |
|---|---|
| 코퍼스 | `paper/` Markdown (400 K chars, vocab = 788) |
| 분할 | 90 % train / 10 % val |
| 토크나이저 | char-level |
...
[7] (Internal) `paper/6_뇌/07_수면과복구.md` — CE 부트스트랩 고정점 `ε² = 4.87 %`.

[8] (Internal) `paper/7_AGI/2_Architecture.md` § 4 — 유니타리 제약.
