...
2026-09-09 최신 연구는 [주제별 읽기 지도](../../../README.md)로 재구성했다. 먼저 [기원 대화 분석](../../00_기원과_현재계획/01_기원_대화와_방향_진단.md)에서 현재 방향과 이전 검증기록의 경계를 확인한다.
...
0. [CE 진전 원장: 닫힌 것·죽은 경로·지금 단 하나의 표적](../../../README.md) — 세션마다 갱신되는 한 화면 현황판. 처음 읽기와 모든 연구 세션의 시작점.
1. [CE 연구 목표 계약: 반복 잔차를 설명하는 공통 원리](../../../검증_원장/연구_목표_계약.md)
2. [최신 연구 조립 목차: 측정, 접힘과 암흑 표현](../../../README.md)
