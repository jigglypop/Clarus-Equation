...
정확한 형식 지위는 차원 분류 원장 C4 (미확보 경로: `../검증_원장/참조_차원_분류_원장.md#조건부-0dlorentzian-plebanskieinstein-폐쇄`)에 고정돼 있다. 이 장은 원장을 바꾸지 않고, 처음 읽는 사람이 그 지위를 따라갈 수 있게 설명한다. CE의 큰 서사인 **끼임 → 접힘 → 암흑 표현** 가운데 여기서 형식적으로 다루는 것은 첫째와 둘째다. 접힌 가능성이 남는다는 유한 정리까지가 접힘의 범위다. 그것이 암흑에너지로 읽힌다는 마지막 단계는 아직 열려 있다.
