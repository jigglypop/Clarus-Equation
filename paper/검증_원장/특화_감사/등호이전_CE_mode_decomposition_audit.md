...
이하로 만들 충분조건을 원하면
[../참조/9_등호이전/05l_CE_uncertainty_floor.md](../../레거시/참조/9_등호이전/05l_CE_uncertainty_floor.md) 4절에 의해
$$
\frac{rm^2}{N}\bigl(1+(N-1)\rho\bigr)
\leq
2e^{-C}\log(1+\delta)
...
**[정리]** [../참조/9_등호이전/05l_CE_uncertainty_floor.md](../../레거시/참조/9_등호이전/05l_CE_uncertainty_floor.md)
...
반면 [../참조/9_등호이전/05k_CE_hard_constraint.md](../../레거시/참조/9_등호이전/05k_CE_hard_constraint.md)의 extensive
