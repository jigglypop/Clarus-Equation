...
[../참조/9_등호이전/05_CE_브리지.md](../../레거시/참조/9_등호이전/05_CE_브리지.md) 1절의 good-rate와 recovery mass
...
경우에는 [../참조/9_등호이전/05i_CE_physical_path_prior.md](../../레거시/참조/9_등호이전/05i_CE_physical_path_prior.md)
정리 2.2에 의해 분모가 0이다.
