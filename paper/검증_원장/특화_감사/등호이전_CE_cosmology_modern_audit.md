...
[05m_CE_mode_decomposition_audit.md](등호이전_CE_mode_decomposition_audit.md)의
독립 Gamma benchmark는
$$
\Phi_N\sim
...
[../참조/9_등호이전/05o_CE_residual_cosmology_forward_model.md](../../레거시/참조/9_등호이전/05o_CE_residual_cosmology_forward_model.md)
