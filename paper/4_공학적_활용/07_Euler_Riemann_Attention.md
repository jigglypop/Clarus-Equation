...
## 7.3 벤치 결과 (모두 char-level LM, 400K-char paper corpus, 2-layer, $d_{\text{model}}=96$)
...
[`paper/8_리만/mra_paper.md`](../8_리만/mra_paper.md) §7.3의 더 큰 실험(1500 step × 3 seed)에서
...
- 모든 유도는 `paper/경로적분.md` §51-67 최소생성문법과 `paper/1_강의/A_연역적_유도.md` §801 고정점 개념에 근거.
